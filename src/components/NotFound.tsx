  ...
  return (
    <div className="fixed inset-0 z-[100] bg-obsidian flex items-center justify-center overflow-hidden">
        ...
        >
          <div className="flex justify-center mb-8">
            <div className="relative">
              ...
              <ShieldAlert
                size={80}
                className="text-nebula-cyan relative z-10 animate-bounce"
              />
            </div>
          </div>
          ...
          <p className="text-dim text-lg md:text-xl font-light mb-12 max-w-md mx-auto leading-relaxed">
            The record you are looking for has been purged or moved to a
            restricted sector.
          </p>
      ...
      <div className="absolute top-10 left-10 hidden md:block">
        <div className="text-nebula-cyan/30 text-[10px] font-mono tracking-widest uppercase mb-1">
          Sector_7G
        </div>
      ...
      <div className="absolute bottom-10 right-10 hidden md:block">
        <div className="text-white/20 text-[10px] font-mono tracking-widest uppercase mb-1">
          Coord: 0.0.0.0
        </div>
