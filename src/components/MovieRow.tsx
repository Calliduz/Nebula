...
export const MovieRow: React.FC<MovieRowProps> = ({ title, children, onTitleClick }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {onTitleClick && (
          <ChevronRight size={24} className="text-dim group-hover/title:text-nebula-cyan group-hover/title:translate-x-1 transition-all" />
        )}
      </div>
      ...
      <div className="relative">
        ...
        <div 
          ...
          className="flex gap-4 sm:gap-6 overflow-x-auto py-4 -my-4 px-4 -mx-4 custom-scrollbar snap-x snap-mandatory scroll-smooth"
        >
          {children}
        </div>
