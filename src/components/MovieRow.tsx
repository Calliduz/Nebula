...
export const MovieRow = memo<MovieRowProps>(
  ({ title, children, onTitleClick }) => {
      ...
      >
        ...
        <div className="relative">
          ...
          <div
            ...
            className="flex gap-2.5 sm:gap-5 overflow-x-auto overflow-y-hidden py-4 -my-4 pr-4 sm:px-0 custom-scrollbar snap-x snap-proximity scroll-smooth select-none transform-gpu"
          >
  ...
  (prevProps, nextProps) => {
    return (
      ...
      Boolean(prevProps.onTitleClick) === Boolean(nextProps.onTitleClick) &&
