...
export const MovieSkeleton: React.FC<MovieSkeletonProps> = ({
  ...
  <div
    className={`relative ${isGrid ? "w-full" : "w-[115px] sm:w-[155px] md:w-[200px] lg:w-[220px]"} shrink-0 aspect-[2/3] rounded-xl md:rounded-2xl shimmer-bg border border-white/5 snap-start`}
  >
